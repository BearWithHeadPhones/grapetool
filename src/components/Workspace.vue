...
export default defineComponent({
  ...
  methods: {
    goToBookmark(bookamrkLine) {
      this.bookamrkLineRelative = this.indexToScrollIndex(bookamrkLine);
      this.scrollTo(bookamrkLine);
    ...
    scrollTo(bookamrkLinel) {
      this.$refs.virtualListRef.scrollTo(
        this.indexToScrollIndex(bookamrkLinel),
        "center"
      );
    },
